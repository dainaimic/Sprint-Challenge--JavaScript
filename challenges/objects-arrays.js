...
/*Once uou have the new array created, sort the universities alphabetically and log the result.*/
...
*/
const lowCaseAnimalNames = zooAnimals.map(zooAnimals => zooAnimals.animal_name = zooAnimals.animal_name.toLowerCase())
